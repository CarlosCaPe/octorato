...
- [Synapses — The Skill Layer (208 reusable techniques)](#synapses--the-skill-layer-208-reusable-techniques)
...
|----------------|----------------------|-------------|
| Central brain | `~/.claude/` (this repo) | Shared rules, paradigms, 167 specialist agents, 208 skills |
| Arms | Client project repos | Isolated workspaces — each client is a sealed arm |
| Neurons | Agent personas | 167 specialist agents across 13 divisions |
| Synapses | Skills | 208 reusable techniques that connect agents to capabilities |
...
│     - 208 generic skills (techniques, not client workflows)   │
...
## Synapses — The Skill Layer (208 reusable techniques)
...
2D Delegate Q1 — Ventosas (Chemoreceptor search)
   ...
   ranks all 208 synapses by cosine similarity to their stored
...
```bash
ls ~/.claude/skills/                                          # All 208 by name
