...
DIRECTIVE = (
    ...
    "2) Barrido COMPLETO, no por termino ni fecha corta: "
    "`in:all newer_than:14d` sin filtros restrictivos (sube la ventana si hace falta). "
    "REGLA: usa `in:all` (incluye Spam y Papelera); `in:inbox` los EXCLUYE y es el fallo recurrente "
    "(cobranza/legal/seguridad caen ahi). "
